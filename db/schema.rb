...
ActiveRecord::Schema[7.2].define(version: 2026_05_15_000001) do
  ...
  create_table "FEG", primary_key: "FEGID", id: { type: :string, limit: 50 }, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "FEGNAME", primary_key: ["FIRST", "LAST"], charset: "utf8mb3", force: :cascade do |t|
    t.string "FIRST", limit: 24, null: false
    t.string "LAST", limit: 32, null: false
    t.string "FEGNAME", limit: 128
  end

  create_table "FEGWORD", primary_key: "WORDID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "GIG", primary_key: "GIGID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["cancelled"], name: "index_GIG_on_cancelled"
  end

  create_table "GSET", primary_key: "SETID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "MEDIA", primary_key: "MCODE", id: { type: :string, limit: 1 }, charset: "utf8mb3", force: :cascade do |t|
    t.string "Medium", limit: 16
  ...
  create_table "MUSO", primary_key: "MUSOID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "Paste Errors", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.string "Song"
  ...
  create_table "SITE", primary_key: "SITEID", id: { type: :string, limit: 4 }, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "SONG", primary_key: "SONGID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "TRAK", primary_key: "TRAKID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "COMPID"
    t.integer "SONGID"
    t.string "Song"
  ...
  create_table "VENUE", primary_key: "VENUEID", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "XREF", primary_key: "XREFID", id: { type: :string, limit: 12 }, charset: "utf8mb3", force: :cascade do |t|
